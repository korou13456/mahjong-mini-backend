...
module.exports = {
  apps: [
    ...
    {
      name: "order-detail-aggregate",
      script: "./scripts/order-detail-aggregate/index.js",
      instances: 1,
      exec_mode: "fork",
      autorestart: false,
      watch: false,
      ...
      error_file: "./logs/order-detail-aggregate-error.log",
      out_file: "./logs/order-detail-aggregate-out.log",
      log_file: "./logs/order-detail-aggregate-combined.log",
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      time: true,
      // 保持进程运行，不因为脚本执行完成而退出
      wait_ready: false,
